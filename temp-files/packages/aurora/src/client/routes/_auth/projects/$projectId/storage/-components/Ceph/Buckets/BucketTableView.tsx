                  ...
                  <DataGridCell onClick={(e) => e.stopPropagation()}>
                    <PopupMenu>
                      <PopupMenuToggle as="div">
                        {/* Juno's default Button variant carries a persistent background - fine in a
                            toolbar, but a filled box on every row reads as visual noise. Strip it back
                            to an icon-only trigger while keeping the accessible Button semantics. */}
