...
export function SecurityGroupTableRow({
  ...
  return (
    ...
    >
      ...
      <DataGridCell>
        {/* Neutron omits `stateful` when the stateful-security-group extension is off; absent means stateful,
            same default the BFF filter applies in filterSecurityGroupsByStateful. */}
