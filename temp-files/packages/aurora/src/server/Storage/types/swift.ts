...
// Create container result schema — the container is always created (the PUT succeeded);
// optionsApplied reports whether the follow-up metadata/ACL/quota POST also succeeded.
