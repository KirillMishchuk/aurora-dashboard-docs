...
export const checkDeletedContentInputSchema = projectScopedInputSchema
  ...
  // Neither given: the scan would have no prefix at all and would walk the entire bucket to
  ...
  // A folder outside the scanned prefix is never visited, yet it would still be reported -
  // as "clean, fully scanned", since a completed scan marks every unseen folder covered.
