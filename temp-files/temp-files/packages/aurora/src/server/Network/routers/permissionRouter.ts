...
const NETWORK_MAPPINGS = {
  ...
  // No update entry: security group rules are immutable in Neutron — every attribute is declared
  // allow_put: false and the plugin has no update_security_group_rule method, so rules can only
