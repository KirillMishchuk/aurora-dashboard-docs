...
- Do NOT mention the quantity of files changed (e.g., "23 files changed")
...
- **Test Updates** / **Test coverage** sections - tests are implied by the feature, no need to list them
- **i18n** / **Localization** / **Translation** sections - locale updates are mechanical and add noise
- Quantity of changed files - this is visible in GitHub UI already
