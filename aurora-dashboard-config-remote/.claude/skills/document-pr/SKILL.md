...
`CLAUDE.md`/`AGENTS.md` plus any `CLAUDE.md`/`AGENTS.md` in directories the
...
Create `../../DOCS/aurora-dashboard-kb/prs/` if it doesn't exist yet. File name:
...
Maintain `../../DOCS/aurora-dashboard-kb/prs/README.md` as a lookup table,
newest first:
