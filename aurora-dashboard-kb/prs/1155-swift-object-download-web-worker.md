...
**Ни одна находка не набрала ≥80 confidence — формальных подтверждённых проблем нет.** Ниже — две находки, упёршиеся в порог (75/75), и две отклонённые, для полноты картины.
...
---
Проанализировано: 11.08.2026 · коммит `97430ad`
